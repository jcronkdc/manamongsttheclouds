...
export const books = {
  manAmongstTheClouds: {
    ...
    keywords:
      "literary fantasy, magic is memory, epic fantasy debut, books like Name of the Wind, books like Assassin's Apprentice, books like Tigana, fantasy books where magic has a cost, best fantasy books 2026, unique magic systems, character-driven fantasy",
