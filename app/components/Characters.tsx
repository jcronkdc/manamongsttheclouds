  ...
  return (
    <section id="characters" className="py-16 sm:py-28 bg-[#080808] relative">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 md:gap-x-12 md:gap-y-14 px-5 sm:px-6">
          {chars.map((c) => (
            <article
              key={c.name}
            ...
            >
              ...
              <h3 className="font-[family-name:var(--font-serif)] text-xl md:text-2xl text-[#ededed] mb-4">
                {c.name}
              </h3>
