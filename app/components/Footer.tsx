...
export default function Footer() {
  return (
    <footer className="py-20 px-6 border-t border-[#1a1a1a] relative">
      <div className="max-w-4xl mx-auto">
        {/* Closing quote */}
        <p className="font-[family-name:var(--font-serif)] text-xl sm:text-2xl italic text-[#444] text-center max-w-xl mx-auto leading-relaxed mb-16">
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                <a
                  key={l.href}
                  href={l.href}
                  className="font-[family-name:var(--font-sans)] text-xs text-[#666] hover:text-[#ededed] transition-colors"
                >
                  {l.label}
                </a>
              ))}
        ...
        <div className="border-t border-[#1a1a1a] pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-[family-name:var(--font-sans)] text-[10px] tracking-[0.2em] uppercase text-[#333]">
            Man Amongst the Clouds
          </p>
          <p className="font-[family-name:var(--font-sans)] text-[10px] text-[#333]">
