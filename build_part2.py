#!/usr/bin/env python3
"""
Compiles Part II: The Waking (Chapters 11-22) into a printable Word document.
"""
...
OUTPUT_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Part II - The Waking.docx")
...
def add_title_page(doc):
    ...
    run = sub.add_run("Part II: The Waking")
    run.font.size = Pt(16)
    run.font.name = 'Georgia'
    run.italic = True
...
def add_part_header(doc):
    ...
    run = ep.add_run('"To learn what you are, first you must lose\neverything you were."')
    run.font.size = Pt(11)
    run.font.name = 'Georgia'
    run.italic = True
