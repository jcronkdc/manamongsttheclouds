    ...
    <section className="py-20 sm:py-24 px-5 sm:px-6 bg-[#0f0f0f]">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-16">
          ...
          <div className="font-[family-name:var(--font-sans)] text-sm leading-relaxed text-[#c4beb4] space-y-4">
            <p>
              Every word of prose in <em>Man Amongst the Clouds</em> was written
              by Justin Cronk. The story, characters, world, magic system, and
              every creative decision are entirely his own &mdash; developed
              over nine years beginning in March 2017.
            </p>
            <p>
            ...
            <ul className="list-none space-y-2 pl-4 border-l border-[#c9a84c]/20">
              <li>
                ...
                auditing across 48 chapters and 153,000 words
              </li>
              <li>
            ...
            <p className="text-[#ededed]">
              AI helped check the work. The work is mine. &mdash;{" "}
              <em>Justin</em>
            </p>
          </div>
          <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              className="px-6 py-2 border border-[#333] text-[#b0a89e] font-[family-name:var(--font-sans)] text-xs tracking-widest uppercase hover:border-[#c9a84c] hover:text-[#c9a84c] transition-colors text-center"
            >
              Verify on GPTZero
            </a>
            <a
          ...
          <p className="font-[family-name:var(--font-sans)] text-xs text-[#777] text-center mt-4">
