  ...
  return (
    ...
    >
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="font-[family-name:var(--font-sans)] text-[10px] tracking-[0.2em] text-[#666] mb-10">
          No account &bull; No signup &bull; Prologue + Chapters 1&ndash;10
        </p>
        ...
        <p className="font-[family-name:var(--font-sans)] text-[10px] tracking-[0.2em] text-[#888] mt-3 mb-14">
          <a
            href="https://www.amazon.com/dp/B0GSSPN6LN"
            target="_blank"
            rel="noopener noreferrer"
